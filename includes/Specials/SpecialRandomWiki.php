	...
	public function execute( $par ): void {
		...
		$formDescriptor = [
			...
			'language' => [
				'type' => 'language',
				'name' => 'language',
				'label-message' => 'compass-table-language',
				'default' => 'en',
			],
			'category' => [
				'type' => 'select',
				'name' => 'category',
				'label-message' => 'compass-table-category',
				'required' => true,
		...
		if ( $this->getConfig()->get( 'CreateWikiUseInactiveWikis' ) ) {
			$formDescriptor['state'] = [
				'type' => 'select',
				'name' => 'inactive',
				'label-message' => 'compass-table-state',
				'options-messages' => [
					'compass-label-any' => '*',
					'compass-label-active' => 'active',
					'compass-label-inactive' => 'inactive',
				],
				'default' => '*',
			];
		}
